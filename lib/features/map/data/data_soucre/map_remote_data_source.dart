...
class MapRemoteDataSource {
  ...
  Future<LatLng> calculateUtm(
      double northing, double easting, int zone, String band) async {
    try {
      String lat = '';
      String long = '';
      final url = Uri.parse(
          'https://awsm-tools.com/utm-to-lat-long?form%5Beasting%5D=$easting&form%5Bnorthing%5D=$northing&form%5Bzone%5D=$zone&form%5Bband%5D=${band.toUpperCase()}&form%5Bellipsoid%5D=WGS+84');
      final response = await http.get(url);
      dom.Document html = dom.Document.html(response.body);
      final titles1 = html
          .querySelectorAll(
              "body > div.content > div.container.section > table > tbody > tr:nth-child(1) > td > span > span")
